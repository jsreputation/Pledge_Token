...
Initializable, ContextUpgradeable, IERC20Upgradeable, IERC20MetadataUpgradeable, OwnableUpgradeable {
    ...
    // function preferredCharityAddress (address holder) virtual public returns(address) {
    //     require(holder != address(0), "Invalid address");
    //     address preferred = _preferredCharityAddress[holder];
    //     if(! isCharityAddress[preferred] ) {
    //         _preferredCharityAddress[holder] = address(0);
    //         return address(0);
    //     } else {
    //         return preferred;
    //     }
