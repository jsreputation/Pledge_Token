...
import "./Pledge07Up.sol";

contract Pledge08Up is Pledge07Up {

	///////////// Initialization functions, following OpenZeppelin's stype. Not required /////////////

    function __PledgeV8_init() public initializer {
		__Ownable_init();
	    __PledgeV8_init_unchained();
	}

    function __PledgeV8_init_unchained() public initializer {
    }
